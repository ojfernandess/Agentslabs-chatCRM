...
import { intelligentTaggingRoutes } from "./routes/intelligentTagging.js";
...
import { billingProviderRoutes } from "./routes/billingProviders.js";
...
import { sipCredentialsRoutes } from "./routes/sipCredentials.js";
...
import { superBillingRoutes } from "./routes/superBilling.js";
...
await app.register(intelligentTaggingRoutes, { prefix: "/api/v1/intelligent-tagging" });
...
await app.register(billingProviderRoutes, { prefix: "/api/v1/billing" });
...
await app.register(sipCredentialsRoutes, { prefix: "/api/v1/sip" });
