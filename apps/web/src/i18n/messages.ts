...
export const messages = {
  "pt-BR": {
    ...
    settings: {
      ...
      appearanceIntro: "Personalize as cores de fundo e texto dos balões de conversa entre cliente e atendente, no modo claro e escuro.",
  ...
  en: {
    ...
    settings: {
      ...
      appearanceIntro: "Customize background and text colors for client and agent conversation bubbles in light and dark mode.",
