...
export const messages = {
  "pt-BR": {
    ...
    login: {
      ...
      inviteAcceptError: "Não foi possível concluir o registo.",
    },
    dashboard: {
      title: "Painel",
    ...
    settings: {
      ...
      sectionTeam: "Equipe",
      teamManualSubtitle:
        "Ou crie contas manualmente com palavra-passe inicial (mínimo 8 caracteres).",
      ...
      invitesSubtitle:
        "Envie um email com link de registo. O modelo do email é configurado no super admin (E-mail transacional).",
      invitesEmail: "Email",
      invitesRole: "Função",
      ...
      invitesEmpty: "Nenhum convite pendente.",
      invitesStatus: "Estado",
      invitesExpires: "Expira",
      invitesRevoke: "Revogar",
      invitesRevokeConfirm: "Revogar este convite?",
    ...
    superAdmin: {
      ...
      platformUsersDeleteConfirm:
        "Esta ação é permanente. O utilizador perderá acesso imediato. Registos de auditoria e recursos ligados serão reatribuídos ao seu utilizador.",
  ...
  en: {
    ...
    settings: {
      ...
      invitesRevokeConfirm: "Revoke this invitation?",
