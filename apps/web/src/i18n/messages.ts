...
export const messages = {
  "pt-BR": {
    ...
    conversationDetail: {
      ...
      closureValueHint:
        "Moeda exibida conforme o idioma (BRL em português). Deixe vazio se não houver valor.",
  ...
  en: {
    ...
    conversationDetail: {
      ...
      closureValueHint: "Currency follows locale (USD in English). Leave empty if not applicable.",
