...
export const messages = {
  "pt-BR": {
    ...
    chatbotPage: {
      ...
      selectHint:
        "Construtor visual no estilo Typebot: blocos encadeados, variáveis, condições e ligação a um bot para WhatsApp.",
      flowName: "Nome",
      ...
      draft: "Rascunho",
      save: "Guardar",
      confirmDelete: "Eliminar este fluxo e sessões associadas?",
      loadError: "Não foi possível carregar os fluxos.",
      publicId: "ID público",
      linkBot: "Ligar a bot",
      linkBotHint:
        "Ao ligar, o bot passa a usar este fluxo visual (sem webhook externo nem agente LLM nativo).",
      noBot: "Nenhum bot",
      applyLink: "Aplicar ligação",
      ...
      promptPlaceholder: "Pergunta ao utilizador…",
      ...
      blockAddTag: "Adicionar etiqueta",
      blockHandoff: "Transferir humano",
      blockWait: "Espera",
      blockJump: "Saltar",
      blockEnd: "Fim",
      catEvents: "Eventos",
      ...
      canvasHint: "Ligue os blocos arrastando das alças · Pan: arrastar fundo · Zoom: roda do rato",
      editorBadge: "Editor visual",
      settingsTitle: "Configuração do bloco",
      settingsEmpty: "Nenhum bloco seleccionado",
      settingsEmptyHint: "Clique num bloco no canvas para editar",
      ...
      jumpTarget: "Ir para bloco",
      handoffMessage: "Mensagem de transferência",
      blockStartDesc: "Ponto de entrada do fluxo",
      blockEndDesc: "Termina a conversa",
      blockTextDesc: "Mensagem ao utilizador",
      blockImageDesc: "Imagem por URL",
      blockTextInputDesc: "Aguarda texto livre",
      blockChoiceInputDesc: "Botões numerados",
      blockConditionDesc: "Ramificação Sim/Não",
      blockSetVariableDesc: "Grava variável de sessão",
      blockWebhookDesc: "Chamada HTTP externa",
      blockAddTagDesc: "Etiqueta no contacto",
      blockHandoffDesc: "Passa para atendente",
      blockWaitDesc: "Pausa antes do próximo bloco",
      blockJumpDesc: "Salta para outro bloco",
      blockGenericDesc: "Bloco de fluxo",
    },
    broadcastPage: {
