...
export const messages = {
  "pt-BR": {
    ...
    automationPage: {
      ...
      agentHint:
        "Cada perfil está ligado a um bot já criado em Bots. O motor LLM externo continua no seu webhook; aqui centraliza-se conhecimento, ferramentas declaradas e registo de interações.",
  ...
  en: {
    ...
    automationPage: {
      ...
      agentHint:
        "Each profile binds to a bot from the Bots page. The LLM still runs in your webhook; this hub stores knowledge, declared tools, and interaction logs.",
