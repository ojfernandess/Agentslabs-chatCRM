...
export const messages = {
  "pt-BR": {
    ...
    automationPage: {
      ...
      agentVoiceHelp: "Ative TTS no fluxo do integrador. Configure uma ferramenta ElevenLabs em Ferramentas, se necessário.",
      ...
      agentNativeTools: "Ferramentas nativas (MCP / fluxo)",
      agentNativeToolsHelp: "Clique para ativar ou desativar. listar hotéis / informações: estabelecimentos; listar entidades: entidades genéricas.",
      ...
      contextBlurb:
        "Estado por conversa e política de limpeza de memória. Use a API PUT /api/v1/automation/conversation-context/:conversationId ou limpe com POST .../clear. Agendamentos internos: página de Lembretes.",
      refresh: "Atualizar",
    },
    broadcastPage: {
  ...
  en: {
    ...
    automationPage: {
      ...
      agentVoiceHelp: "Enable TTS in your integrator. Add an ElevenLabs custom tool if needed.",
      ...
      agentNativeTools: "Native tools (MCP / flow)",
      agentNativeToolsHelp: "Click to toggle. Hotels tools: establishments; entity tools: generic entities.",
      ...
      contextBlurb:
        "Per-conversation state and memory policy. Use PUT /api/v1/automation/conversation-context/:conversationId or POST .../clear. Internal scheduling: Reminders page.",
      refresh: "Refresh",
    },
    broadcastPage: {
