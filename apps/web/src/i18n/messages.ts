...
export const messages = {
  "pt-BR": {
    ...
    settings: {
      ...
      appearanceIntro: "Personalize as cores dos balões de conversa entre cliente e atendente, no modo claro e escuro.",
  ...
  en: {
    ...
    settings: {
      ...
      appearanceIntro: "Customize conversation bubble colors for client and agent messages in light and dark mode.",
