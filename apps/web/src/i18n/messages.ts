  ...
  "pt-BR": {
    ...
    inboxesPage: {
      ...
      wizard: {
        ...
        channelNoteOther:
          "Cada caixa recebe um URL de webhook com token. Envie JSON (participantId, body/text) para abrir conversas nesta caixa. Telegram e Twilio têm caminhos dedicados no mesmo prefixo.",
        doneHint: "Filtre conversas por esta caixa no menu lateral ou na lista de conversas.",
        ingestJsonUrl: "Entrada JSON (API / widget)",
        ingestTelegramUrl: "Telegram Bot API (update JSON)",
        ingestTwilioUrl: "Twilio (SMS / número) form POST",
        ingestCopy: "Copiar",
        ingestNoteWhatsApp:
  ...
  en: {
    ...
    inboxesPage: {
      ...
      wizard: {
        ...
        channelNoteOther:
          "Each inbox gets a secret ingest URL. POST JSON with participantId and body/text to open threads in this inbox. Telegram and Twilio have dedicated paths under the same prefix.",
        doneHint: "Filter conversations by this inbox from the sidebar or conversation list.",
        ingestJsonUrl: "JSON ingest (API / widget)",
        ingestTelegramUrl: "Telegram Bot API (update JSON)",
        ingestTwilioUrl: "Twilio SMS / WhatsApp (form POST)",
        ingestCopy: "Copy",
        ingestNoteWhatsApp:
