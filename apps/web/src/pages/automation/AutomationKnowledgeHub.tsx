...
export function AutomationKnowledgeHub({
  ...
  const [pgProvider, setPgProvider] = useState<"openai" | "google_gemini" | "kimi" | "xai" | "anthropic">(
    "openai",
  );
          ...
          <div className="space-y-3 rounded-2xl border border-ink-200 bg-white/90 p-4 dark:border-ink-700 dark:bg-ink-900/60 lg:col-span-2">
            ...
            <label className="block text-xs">
              ...
              <select
                value={pgProvider}
                onChange={(e) => {
                  const p = e.target.value as "openai" | "google_gemini" | "kimi" | "xai" | "anthropic";
                  setPgProvider(p);
                  if (p === "google_gemini") setPgModel("gemini-3.5-flash");
                  else if (p === "kimi") {
                    setPgModel("kimi-k3");
                    ...
                    setPgModel("claude-sonnet-5");
                    setPgBaseUrl("https://api.anthropic.com");
                  } else {
