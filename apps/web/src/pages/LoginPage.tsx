    ...
    <div className="flex min-h-screen items-center justify-center bg-ink-50 px-4">
      ...
      >
        <div className="mb-8 text-center">
          ...
          />
          <h1 className="text-2xl font-bold text-ink-900">{t("login.title")}</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <AnimatePresence>
            {error && (
              <motion.div
                ...
                className="card-surface bg-red-50 px-4 py-3 text-sm text-red-700"
              >
                {error}
              </motion.div>
            )}
          ...
          <motion.button
            type="submit"
            disabled={loading}
            className="btn-primary w-full py-2.5 focus-visible:ring-offset-ink-50"
            whileTap={{ scale: 0.98 }}
          >
