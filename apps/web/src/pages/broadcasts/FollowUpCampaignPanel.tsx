    ...
    <div className="space-y-6">
      ...
      <section className="rounded-2xl border border-ink-200/80 bg-white/90 p-5 shadow-sm dark:border-soft-border dark:bg-[#202736]/55">
        <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          <div className="flex rounded-lg border border-ink-200 p-0.5 dark:border-soft-border">
                ...
                <button
                  ...
                  className={clsx(
                    ...
                    on
                      ...
                      : "border-ink-200 bg-ink-50 text-ink-700 hover:border-brand-300 dark:border-soft-border dark:bg-white/5 dark:text-ink-200",
                  )}
                >
                  <span
