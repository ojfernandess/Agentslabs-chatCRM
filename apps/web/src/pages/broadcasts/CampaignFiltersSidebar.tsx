...
export function CampaignFiltersSidebar({
  ...
  return (
    <aside className="space-y-4 rounded-2xl border border-ink-200/80 bg-white/90 p-4 shadow-sm dark:border-soft-border dark:bg-[#202736]/55">
      ...
      <div>
        ...
        <div className="relative mt-1">
          ...
          <input
            ...
            className="w-full rounded-xl border border-ink-200 bg-white py-2 pl-9 pr-3 text-sm dark:border-soft-border dark:bg-white/5"
          />
        </div>
      </div>
