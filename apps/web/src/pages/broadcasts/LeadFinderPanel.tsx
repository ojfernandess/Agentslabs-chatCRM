...
export function LeadFinderPanel({
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-brand-200/60 bg-gradient-to-br from-brand-50/80 to-white/90 p-5 dark:border-brand-800/40 dark:from-brand-950/25 dark:to-[#202736]/55">
          ...
          <section className="rounded-2xl border border-ink-200/80 bg-white/90 p-5 shadow-sm dark:border-soft-border dark:bg-[#202736]/55">
            ...
            {searchMode === "segment" ? (
              <div className="mt-4 space-y-4">
                ...
                {showSegmentForm ? (
                  <div className="rounded-xl border border-ink-100 bg-ink-50/50 p-4 dark:border-soft-border dark:bg-white/5">
              ...
              <section className="rounded-2xl border border-ink-200/80 bg-white/90 p-5 shadow-sm dark:border-soft-border dark:bg-[#202736]/55">
                ...
                <div className="mt-4 overflow-x-auto">
                  <table className="min-w-full text-left text-sm">
                    <thead>
                      <tr className="border-b border-ink-200 text-xs uppercase text-ink-500 dark:border-soft-border">
                    ...
                    <tbody>
                      {results.map((row, index) => {
                        ...
                        <tr
                          ...
                          className={clsx(
                            "border-b border-ink-100 dark:border-soft-border/70",
