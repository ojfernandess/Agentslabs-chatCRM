      ...
      {loading ? (
        ...
        <div className="mt-4 overflow-x-auto">
          <table className="w-full min-w-[640px] text-left text-xs">
            <thead>
              <tr className="border-b border-ink-200 text-[10px] font-bold uppercase tracking-wide text-ink-500 dark:border-soft-border">
            ...
            <tbody>
              {sendLog.items.map((row) => {
                ...
                return (
                  <tr key={row.id} className="border-b border-ink-100 dark:border-soft-border/70">
      ...
      {total > pageSize ? (
        <div className="mt-4 flex items-center justify-between gap-2">
          <button
            ...
            className="inline-flex items-center gap-1 rounded-lg border border-ink-200 px-2 py-1 text-xs font-semibold disabled:opacity-40 dark:border-soft-border"
          >
