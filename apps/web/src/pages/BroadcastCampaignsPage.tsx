  ...
  return (
    <PageTransition>
          ...
          <span
            ...
            className={clsx(
              ...
              ch.available
                ...
                : "border-ink-200 bg-ink-50 text-ink-500 dark:border-soft-border dark:bg-white/5 dark:text-ink-400",
            )}
          >
            {t(ch.labelKey)}
            {!ch.available ? (
      ...
      {Object.keys(statusFunnel).length > 0 ? (
        <div className="flex flex-wrap gap-2 rounded-2xl border border-ink-200/80 bg-white/60 px-4 py-3 dark:border-soft-border dark:bg-white/5">
      ...
      <div className="flex gap-1 overflow-x-auto border-b border-ink-200 dark:border-soft-border">
      ...
      <div className={clsx("grid gap-6", centerTab === "followup" || centerTab === "leadfinder" ? "" : "lg:grid-cols-[240px_1fr]")}>
        ...
        <div className={clsx("min-w-0", centerTab === "followup" && "max-w-3xl")}>
          ...
          {centerTab === "campaigns" ? (
            <>
              {loading ? (
                ...
                <div className="rounded-2xl border border-dashed border-ink-200 p-12 text-center dark:border-soft-border">
          ...
          {centerTab === "flows" ? (
            <div className="rounded-2xl border border-ink-200/80 bg-white/90 p-8 text-center dark:border-soft-border dark:bg-[#202736]/55">
