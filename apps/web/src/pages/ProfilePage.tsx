            ...
            <div className="mt-4 space-y-4">
                ...
                <div className="mt-1 flex items-center gap-2">
                  ...
                  <button
                    ...
                    className={clsx(
                      ...
                      "dark:border-soft-border dark:bg-white/5 dark:text-ink-100 dark:hover:bg-white/10",
                    )}
              ...
              <div className="space-y-2">
                ...
                <label className="flex cursor-pointer items-start gap-3">
                  <input
                    type="checkbox"
                    className="mt-1 h-4 w-4 shrink-0 rounded border-ink-300 text-brand-600 focus:ring-brand-500 dark:border-soft-border dark:bg-ink-800"
