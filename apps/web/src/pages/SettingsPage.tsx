            ...
            >
                      ...
                      <>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="rounded-lg border border-ink-200/80 p-2 text-ink-500 hover:bg-ink-50 dark:border-soft-border dark:text-ink-400 dark:hover:bg-white/5"
                          >
                            {copied ? (
              ...
              {section === "appearance" && (
                ...
                >
                  ...
                  <div className="mb-8 rounded-xl border border-ink-200/80 bg-ink-50/50 p-4 dark:border-soft-border dark:bg-ink-950/40">
                  ...
                  <div className="mb-6 grid gap-4 sm:grid-cols-2">
                    <div className="rounded-xl border border-ink-200/80 bg-ink-50/50 p-4 dark:border-soft-border dark:bg-ink-950/40">
                    ...
                    <div className="rounded-xl border border-ink-200/80 bg-ink-950 p-4 dark:border-soft-border">
                        ...
                        <li key={lt.id} className="px-3 py-3 text-sm">
                          {editingLtId === lt.id ? (
                            ...
                            >
                              ...
                              <div className="rounded-lg border border-ink-200/80 bg-ink-50/50 p-3 dark:border-soft-border dark:bg-white/5">
