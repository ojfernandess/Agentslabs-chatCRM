  ...
  return (
    <div className="space-y-3">
      ...
      {configured.length > 0 ? (
              ...
              <button
                ...
                className={clsx(
                  ...
                  active
                    ...
                    : "border-ink-200/80 bg-white hover:border-brand-200 hover:bg-brand-50/30 dark:border-soft-border dark:bg-black/10 dark:hover:border-brand-800",
                )}
              >
        ...
        <p className="rounded-lg border border-dashed border-ink-200 px-3 py-4 text-sm text-ink-500 dark:border-soft-border">
              ...
              <button
                ...
                className={clsx(
                  ...
                  activeProvider === item.id
                    ...
                    : "border-ink-200 text-ink-600 hover:bg-ink-50 dark:border-soft-border dark:text-ink-300",
                )}
              >
