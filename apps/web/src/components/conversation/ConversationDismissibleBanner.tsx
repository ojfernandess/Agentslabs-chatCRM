...
export function ConversationDismissibleBanner(props: ConversationDismissibleBannerProps) {
  ...
  return (
    <div className="relative z-20 shrink-0 border-b border-ink-100/80 bg-white/70 px-3 py-2.5 backdrop-blur-sm dark:border-soft-border dark:bg-[#151826]/45 sm:px-5">
      {banner}
    </div>
  );
}
