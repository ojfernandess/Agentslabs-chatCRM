...
import { isWebsiteContactPhone, websitePhoneDisplay } from "@/lib/contactWebsiteDisplay";
...
export function ContactProfileDrawer({
  ...
  onRequestDelete?: (c: { id: string; name: string }) => void;
                  ...
                  <>
                    ...
                    {onRequestDelete ? (
                      <button
                        type="button"
                        onClick={() =>
                          onRequestDelete({ id: contact.id, name: contact.name })
                        }
                        className="rounded-lg border border-red-200 p-2 text-red-600 hover:bg-red-50 dark:border-red-900/50 dark:text-red-400 dark:hover:bg-red-950/40"
